        ...
        <div style="display: flex; margin-top: 25px; height: 500px">
            ...
            <div class="detail-cont">
                ...
                <div style="justify-content: space-between; display: flex;">
                    ...
                    <asp:Button ID="btnPublish" OnClick="verifybtn_Click" OnClientClick="return confirm('Are you sure you want to verify this resolution ?')" runat="server" CssClass="btn" Text="Publish" />
                </div>
