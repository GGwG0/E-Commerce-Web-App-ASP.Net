<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="FillUpBoardResolution.aspx.cs" Inherits="FYP_WebApplication.FillUpBoardResolution" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="content-1">
                    <p>Fill Up Board Resolution Template</p>
                    <div style="display: flex; margin-top: 25px;">
                        ...
                        <div class="detail-cont">
                            ...
                            <div style="justify-content: space-between; display: flex;">
                                <asp:Button ID="addbtn" runat="server" CssClass="btn" Text="Create Resolution" OnClick="submit_Click" />
