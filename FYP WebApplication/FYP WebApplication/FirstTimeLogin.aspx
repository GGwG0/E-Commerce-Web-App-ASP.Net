    ...
    <form id="form1" runat="server">
        ...
        <div class="profileContainer">
            ...
            <div class="rightContainer">
                <p>First Time Login
                    <asp:Label ID="Label1" runat="server" CssClass="fa fa-info-circle" ToolTip="Please change your password and upload your signature."></asp:Label></p>
                <div class="row">
                    <div class="row">
                        ...
                        <div>
                            ...
                            <div class="field">
                                <asp:TextBox Width="50%" ID="txtNewPassword" runat="server" CssClass="textbox" TextMode="Password"></asp:TextBox>
                            </div>
                        </div>
                         <br />
                        <div>
                            ...
                            <div class="field">
                                <asp:TextBox  Width="50%"   ID="txtConfirmPassword" runat="server" CssClass="textbox" TextMode="Password"></asp:TextBox>
                            </div>
                        </div>
                         <br />
                        <div>
                            <span>Insert Signature:
                                <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                            </span>
                            <div>
                                <canvas id="signatureCanvas" width="400" height="200" runat="server"></canvas>
                            </div>
                        </div>
                         <br />
                        ...
                        <asp:UpdatePanel ID="updatePanel" runat="server">
                            <ContentTemplate>
                                <br />
                               <asp:Button Width="50%" ID="btnSubmit" runat="server" Text="Submit" OnClientClick="saveSignature(); return false;" OnClick="btnSubmit_Click" CssClass="btnLogin_Click" />
