...
namespace FYP_WebApplication
{
    public partial class CreateUser : System.Web.UI.Page
    {
        ...
        protected void sendEmail(string username, string password)
        {
            ...
            message.Body = "Dear sir/ madam,  " + "\n" + " Good day! Your account for the company secretary system has been created. Please be informed that you have to change the password to activate your account successfully." + "\n\n" + "Username : " + username + "\n"
        ...
        protected void ddlCompany_DataBinding()
        {
            ...
            {
                selectQuery = "SELECT * FROM Company WHERE createdBy = 32 AND NOT EXISTS( SELECT 1 FROM [User] WHERE Company.companyID = [User].companyID)";
            }
