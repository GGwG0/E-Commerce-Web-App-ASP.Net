                        ...
                        <div style="width: 70%;">
                             <div class="detail-inner-cont">
                                ...
                                <div style="margin-top: 20px;">
                                    <asp:Label runat="server" Text="Request Type Name :"  CssClass="label" />
                                    <asp:TextBox ID="Name" runat="server" CssClass="TextBox" placeholder="Name"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Name" Display="Dynamic" ErrorMessage="Request Type Name is required"  ForeColor="Red"></asp:RequiredFieldValidator>
