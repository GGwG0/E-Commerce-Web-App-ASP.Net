...
namespace FYP_WebApplication
{
    public partial class EditProfile : System.Web.UI.Page
    {
        ...
        {
            if (Session["currentRole"].ToString() == "client user" || Session["currentRole"].ToString() == "cosec user")
            {
                Response.Redirect("RequestDashboard.aspx");
            }
            else if (Session["currentRole"].ToString() == "client admin" || Session["currentRole"].ToString() == "cosec admin" || Session["currentRole"].ToString() == "service admin" || Session["currentRole"].ToString() == "service user")
            {
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                selectQuery = "Update [User] set name = @name, contactNum = @contactNum, position=@position, email = @email, profilePicture=@picture where userID =@id";
            }
            else
            {
                selectQuery = "Update [User] set name = @name, contactNum = @contactNum, position=@position, email = @email where userID =@id";
            }
