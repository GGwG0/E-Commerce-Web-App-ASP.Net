<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewRequestType.aspx.cs" Inherits="FYP_WebApplication.ViewRequestType" %>
                    ...
                    <div style="display: flex; margin-top: 25px;">
                        <div style="width: 60%;">
                            ...
                            <div style="justify-content: space-between; display: flex;">
                                <asp:Button ID="addbtn" runat="server" CssClass="btn" OnClick="addbtn_Click" Text="Edit" />
